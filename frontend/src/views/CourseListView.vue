...
async function loadCourses() {
  ...
  try {
    ...
    ui.showToast(e?.message || 'Failed to load courses', 'error')
  } finally {
    loading.value = false
  }
}
...
async function submitCreate() {
  ...
  try {
    ...
    ui.showToast(e?.message || 'Failed to create course', 'error')
  } finally {
    saving.value = false
  }
}
...
async function submitEdit() {
  ...
  try {
    ...
    ui.showToast(e?.message || 'Failed to update course', 'error')
  } finally {
    saving.value = false
  }
}
...
async function confirmDelete(course: Course) {
  ...
  try {
    ...
    ui.showToast(e?.message || 'Failed to delete course', 'error')
  }
}
...
async function doApply() {
  ...
  try {
    ...
    ui.showToast(e?.message || 'Failed to apply', 'error')
  }
}
...
async function cancelApply() {
  ...
  try {
    ...
    ui.showToast(e?.message || 'Failed to cancel', 'error')
  }
}
...
async function approveApp(app: CourseApplication) {
  ...
  try {
    ...
    ui.showToast(e?.message || 'Failed to approve', 'error')
  }
}
...
watch(
  ...
  async (gymId) => {
    ...
    try {
      ...
      ui.showToast(e?.message || 'Failed to load gym members', 'error')
      gymMembersList.value = []
    } finally {
...
async function loadGyms() {
  try {
    ...
    ui.showToast(e?.message || 'Failed to load gyms', 'error')
  }
}
</script>
